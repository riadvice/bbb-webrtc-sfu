...
Messaging.prototype.generateScreenshareRTMPBroadcastStartedEvent2x =
  function(conferenceName, screenshareConf, streamUrl, vw, vh, userId, timestamp) {
  let stadrbem = new ScreenshareRTMPBroadcastStartedEventMessage2x(conferenceName, screenshareConf, streamUrl, vw, vh, userId, timestamp);
  return stadrbem.toJson();
}

Messaging.prototype.generateScreenshareRTMPBroadcastStoppedEvent2x =
  function(conferenceName, screenshareConf, streamUrl, vw, vh, userId, timestamp) {
  let stodrbem = new ScreenshareRTMPBroadcastStoppedEventMessage2x(conferenceName, screenshareConf, streamUrl, vw, vh, userId, timestamp);
  return stodrbem.toJson();
}
